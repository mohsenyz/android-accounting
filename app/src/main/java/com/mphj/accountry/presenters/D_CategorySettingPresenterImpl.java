...
public class D_CategorySettingPresenterImpl implements D_CategorySettingPresenter {
    D_CategorySettingView view;

    public D_CategorySettingPresenterImpl(D_CategorySettingView view){
        this.view = view;
    }
    @Override
